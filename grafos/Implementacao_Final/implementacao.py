...
#calcular as posições dos nós em um layout hierárquico ao plotar o grafo.
...
class Grafo:
    ...
    #Executa uma busca em largura no grafo a partir de um vértice de origem
    def bfs(self, raiz):
        fila = []
        fila.append(raiz)
        ...
        while fila:
            ...
            for u in range(self.num_vertices):
                if self.matriz_adjacencia[v][u] == 1 and not self.visitado[u]: #verifica se a aresta entre os vertices e se o vertice u foi visitado
                    fila.append(u) #adiciona o vertice na fila para ser explorado
                    self.visitado[u] = True #vertice visitado
                    componente.append(u)
    ...
    #Gera a árvore de busca em largura a partir de um vértice de origem
    ...
    #Plota a árvore de busca em largura
    ...
    # Identifica e imprime a bipartição do grafo se ele for bipartido
    ...
    # encontra a bipartição utilizando a árvore gerada pela busca em largura a partir de um vértice de origem
    def encontrar_biparticao_com_arvore(self, raiz):
        ...
        indice_frente = 0  # indice do início da fila
        indice_final = 1   # indice do final da fila
    ...
    # mostra a ordem dos vértices visitados durante a busca em largura
    ...
    # Mostra a ordem dos vértices visitados durante a busca em largura, incluindo candidatos para a escolha do vértice raiz
    ...
    # Encontra um ciclo ímpar no grafo se ele não for bipartido
