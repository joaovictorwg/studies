...
# Carregue as imagens
imagem1 = cv2.imread('imagem_adicionada.jpg')
...
# Subtraia as imagens
imagem_subtraida = cv2.subtract(imagem1_rgb, imagem2_redimensionada)
...
axes[2].imshow(imagem_subtraida)
axes[2].set_title('Imagem Subtraída')
axes[2].axis('off')
